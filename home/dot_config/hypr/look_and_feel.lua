...
hl.config({
	general = {
		...
		col = {
			active_border = {
				colors = {
					palette.rgba(palette.cyan, "ee"),
					palette.rgba(palette.blue, "ee"),
					palette.rgba(palette.violet, "ee"),
				},
				angle = 45,
			},
			inactive_border = palette.rgba(palette.borderMuted, "aa"),
		},
	...
	decoration = {
		...
		shadow = {
			...
			range = 16,
			render_power = 3,
			color = palette.rgba(palette.background, "ee"),
		},
		blur = {
			enabled = true,
			size = 3,
